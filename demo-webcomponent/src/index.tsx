...
import DemoWebcomponent from './direflow-components/demo-webcomponent';

DemoWebcomponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('demo-webcomponent is mounted on the DOM', element);
});
